...
public class BudgetSummaryServiceImpl implements BudgetSummaryService {
    ...
    public BudgetSummaryServiceImpl(BudgetPlanRepository budgetPlanRepository) {
        this.budgetPlanRepository = budgetPlanRepository;
    }
    ...
    @Override
    public Double getTotalExpense(Long userId, Integer year, Integer month) {
        // Transaction feature not implemented yet
        return 0.0;
    }

    @Override
    public Double getRemainingBudget(Long userId, Integer year, Integer month) {
        Double totalBudget = getTotalBudget(userId, year, month);
        Double totalExpense = getTotalExpense(userId, year, month);
